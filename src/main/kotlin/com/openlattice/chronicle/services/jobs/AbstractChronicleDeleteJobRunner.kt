 ...
 */
public abstract class AbstractChronicleDeleteJobRunner<T : ChronicleJobDefinition> : AbstractChronicleJobRunner<T>() {
    ...
    public fun updateFinishedDeleteJob(connection: Connection, job: ChronicleJob) {
