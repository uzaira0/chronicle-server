 ...
 */
public class LegacyEdmResolver private constructor() {
    internal companion object {
        ...
        @JvmStatic
        public fun getPropertyTypeId(fqn: FullQualifiedName): UUID = propertyTypes.getValue(fqn)

        @JvmStatic
        public fun getPropertyTypeIds(
         ...
         *
         */
        public fun getLegacyPropertyTypeIds(fqns: Collection<String>): Map<String, UUID> {
