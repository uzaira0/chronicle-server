...
import com.openlattice.chronicle.storage.PostgresEventColumns.Companion.APP_CATEGORY
import com.openlattice.chronicle.storage.PostgresEventColumns.Companion.APP_PACKAGE_NAME
import com.openlattice.chronicle.storage.PostgresEventColumns.Companion.APP_USAGE_TIME
import com.openlattice.chronicle.storage.PostgresEventColumns.Companion.BUNDLE_IDENTIFIER
import com.openlattice.chronicle.storage.PostgresEventColumns.Companion.EVENT_TYPE
import com.openlattice.chronicle.storage.PostgresEventColumns.Companion.ID
...
import com.openlattice.chronicle.storage.PostgresEventTables.Companion.UNIQUE_DATES
 ...
 */
public class ResultSetAdapters private constructor() {
    // reason: central ResultSet→domain mapper registry; splitting would churn pervasive call sites
    ...
    internal companion object {
        ...
        public fun range(rs: ResultSet): Range {
        ...
        @Throws(SQLException::class)
        public fun deviceId(rs: ResultSet): UUID = rs.getObject(DEVICE_ID.name, UUID::class.java)

        @Throws(SQLException::class)
        // reason: vararg AclKey constructor requires spread; UUID arrays are small
        @Suppress("SpreadOperator")
        public fun principalOfAclKey(rs: ResultSet): AclKey {
        ...
        @Throws(SQLException::class)
        public fun securablePrincipal(rs: ResultSet): SecurablePrincipal {
        ...
        @Throws(SQLException::class)
        public fun permissions(rs: ResultSet): EnumSet<Permission> {
            ...
            pStrArray.forEach {
                try {
                    ...
                    logger.warn(
                        "Skipping unknown permission value '{}' found in database. " +
                            "Consider running a data migration to clean up legacy values.",
                        it,
                        e,
                    )
                }
        ...
        @Throws(SQLException::class)
        public fun id(rs: ResultSet): UUID {
            return UUID.fromString(rs.getString(ID.name))
        }

        @Throws(SQLException::class)
        public fun name(rs: ResultSet): String {
            return rs.getString(NAME.name)
        }

        @Throws(SQLException::class)
        public fun title(rs: ResultSet): String {
            return rs.getString(TITLE.name)
        }

        @Throws(SQLException::class)
        public fun description(rs: ResultSet): String {
            return rs.getString(DESCRIPTION.name)
        }

        @Throws(SQLException::class)
        public fun url(rs: ResultSet): String {
            return rs.getString(URL.name)
        }

        @Throws(SQLException::class)
        public fun principal(rs: ResultSet): Principal {
        ...
        // reason: vararg AclKey constructor requires spread; UUID arrays are small
        @Suppress("SpreadOperator")
        public fun aclKey(rs: ResultSet): AclKey {
            return AclKey(*PostgresArrays.getUuidArray(rs, ACL_KEY.name)!!)
        }

        @Throws(SQLException::class)
        public fun aceKey(rs: ResultSet): AceKey {
            val aclKey = aclKey(rs)
            val principal: Principal = principal(rs)
        ...
        @Throws(SQLException::class)
        public fun linkedHashSetUUID(rs: ResultSet, colName: String): LinkedHashSet<UUID> {
            @Suppress("UNCHECKED_CAST")
            return LinkedHashSet<UUID>((rs.getArray(colName).array as Array<UUID?>).filterNotNull())
        }

        @Throws(SQLException::class)
        public fun category(rs: ResultSet): SecurableObjectType {
...
//        }
        ...
        @Throws(SQLException::class)
        public fun securableObjectId(rs: ResultSet): UUID {
            return rs.getObject(SECURABLE_OBJECT_ID.name, UUID::class.java)
        }

        @Throws(SQLException::class)
        public fun securableObjectName(rs: ResultSet): String {
            return rs.getString(SECURABLE_OBJECT_NAME.name)
        }

        @Throws(SQLException::class)
        public fun organizationId(rs: ResultSet): UUID {
            return rs.getObject(ORGANIZATION_ID.name, UUID::class.java)
        }

        @Throws(SQLException::class)
        public fun securableObjectType(rs: ResultSet): SecurableObjectType {
...
//        }
        ...
        @Throws(SQLException::class)
        public fun count(rs: ResultSet): Long {
            return rs.getLong(COUNT)
        }

        @Throws(SQLException::class)
        public fun expirationDate(rs: ResultSet): OffsetDateTime {
            return rs.getObject(EXPIRATION_DATE.name, OffsetDateTime::class.java)
        }

        @Throws(SQLException::class)
        public fun exists(rs: ResultSet): Boolean {
            return rs.getBoolean("exists")
        }

        @Throws(SQLException::class)
        public fun username(rs: ResultSet): String {
            return rs.getString(USERNAME.name)
        }


        @Throws(SQLException::class)
        public fun studyId(rs: ResultSet): UUID = rs.getObject(STUDY_ID.name, UUID::class.java)


        @Throws(SQLException::class)
        public fun legacyStudySettings(rs: ResultSet): Pair<UUID, Pair<String, Map<String, Any>>> {
        ...
        @Throws(SQLException::class)
        public fun studyLimits(rs: ResultSet): StudyLimits {
            return StudyLimits(
        ...
        @Throws(SQLException::class)
        public fun study(rs: ResultSet): Study {
            return Study(
        ...
        @Throws(SQLException::class)
        public fun organization(rs: ResultSet): Organization {
            return Organization(
        ...
        @Throws(SQLException::class)
        public fun candidate(rs: ResultSet): Candidate {
            return Candidate(
        ...
        @Throws(SQLException::class)
        public fun appUsage(rs: ResultSet): AppUsage {
            val timezone = rs.getString(TIMEZONE.name)
            val timestamp = rs.getObject(TIMESTAMP.name, OffsetDateTime::class.java)
            val zoneId = ZoneId.of(timezone)
            val uploadedAt = Optional.ofNullable(rs.getObject(PostgresEventColumns.UPLOADED_AT.name, OffsetDateTime::class.java))
        ...
        @Throws(SQLException::class)
        public fun iosDeviceUsageByCategory(rs: ResultSet): IosDeviceUsageByCategory {
        ...
        @Throws(SQLException::class)
        public fun participantStatus(rs: ResultSet): ParticipationStatus {
            return ParticipationStatus.valueOf(rs.getString(PARTICIPATION_STATUS.name))
        }

        @Throws(SQLException::class)
        public fun candidateId(rs: ResultSet): UUID {
            return rs.getObject(CANDIDATE_ID.name, UUID::class.java)
        }

        @Throws(SQLException::class)
        public fun storage(rs: ResultSet): String {
            return rs.getString(STORAGE.name)
        }

        @Throws(SQLException::class)
        public fun chronicleJob(rs: ResultSet): ChronicleJob {
            return ChronicleJob(
        ...
        @Throws(SQLException::class)
        // reason: boundary catch — optional participant tags default to empty on any read/parse failure
        @Suppress("TooGenericExceptionCaught")
        public fun participant(rs: ResultSet): Participant {
            val tags = try {
                PostgresArrays.getTextArray(rs, PARTICIPANT_TAGS.name).toSet()
            } catch (e: Exception) {
                logger.debug("Unable to read participant tags; defaulting to empty set", e)
                emptySet()
            }
            return Participant(
                ...
                rs.getString(PARTICIPANT_NOTES.name),
                tags,
            )
        }

        @Throws(SQLException::class)
        public fun notification(rs: ResultSet): Notification {
            return Notification(
        ...
        @Throws(SQLException::class)
        public fun questionnaire(rs: ResultSet): Questionnaire {
        ...
        @Throws(SQLException::class)
        public fun participantStats(rs: ResultSet): ParticipantStats {
            @Suppress("UNCHECKED_CAST")
        ...
        @Throws(SQLException::class)
        public fun systemApp(rs: ResultSet): String {
            return rs.getString(APP_PACKAGE_NAME.name)
        }

        @Throws(SQLException::class)
        public fun submissionDate(rs: ResultSet): OffsetDateTime {
            return rs.getObject(SUBMISSION_DATE.name, OffsetDateTime::class.java)
        }

        @Throws(SQLException::class)
        public fun submissionId(rs: ResultSet): UUID {
            return UUID.fromString(rs.getString(SUBMISSION_ID.name))
        }

        @Throws(SQLException::class)
        public fun usageEventQueueEntries(rs: ResultSet): UsageEventQueueEntries {
            ...
            val uploadedAt = rs.getObject(PostgresEventColumns.UPLOADED_AT.name, OffsetDateTime::class.java)
            return UsageEventQueueEntries(studyId, participantId, data, uploadedAt)
        }

        @Throws(SQLException::class)
        public fun sensorDataSamples(rs: ResultSet): SensorDataEntries {
            val studyId = rs.getObject(STUDY_ID.name, UUID::class.java)
            val participantId = rs.getString(PARTICIPANT_ID.name)
            ...
            return SensorDataEntries(studyId, participantId, samples, uploadedAt, deviceId)
        }

        @Throws(SQLException::class)
        public fun participantKey(rs: ResultSet): ParticipantKey {
            return ParticipantKey(studyId(rs), rs.getString(PARTICIPANT_ID.name))
        }

        @Throws(SQLException::class)
        public fun uniqueDates(rs: ResultSet): Set<LocalDate> {
            return rs
        ...
        @Throws(SQLException::class)
        public fun deviceType(rs: ResultSet): SourceDeviceType {
            return SourceDeviceType.valueOf(rs.getString(DEVICE_TYPE.name))
        }

        public fun deviceTypes(rs: ResultSet): Set<SourceDeviceType> {
