...
import com.openlattice.chronicle.authorization.AuthorizedObjectsSearchResult
...
public open class AuthorizationsController @Inject constructor(
    ...
    override fun checkAuthorizations(@Valid @RequestBody queries: Set<AccessCheck>): Iterable<Authorization> {
        return Iterable {
