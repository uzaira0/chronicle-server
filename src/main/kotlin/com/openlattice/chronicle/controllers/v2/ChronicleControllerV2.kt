...
public open class ChronicleControllerV2 : ChronicleApi {
    @Inject
    ...
    @RequestMapping(
            path = [
                ChronicleApi.ORGANIZATION_ID_PATH + ChronicleApi.STUDY_ID_PATH +
                    ChronicleApi.PARTICIPANT_ID_PATH + ChronicleApi.DATASOURCE_ID_PATH + ChronicleApi.ENROLL_PATH
            ],
    ...
    override fun enroll(
            ...
            @Valid @RequestBody sourceDevice: Optional<SourceDevice>
    ): UUID {
        ...
        return if (sourceDevice.isPresent) {
            ...
            val id = enrollmentManager.registerDevice(realStudyId, participantId, deviceId, sourceDevice.get())
    ...
    @RequestMapping(
            path = [
                ChronicleApi.ORGANIZATION_ID_PATH + ChronicleApi.STUDY_ID_PATH +
                    ChronicleApi.PARTICIPANT_ID_PATH + ChronicleApi.ENROLLMENT_STATUS_PATH
            ],
            method = [RequestMethod.GET]
    )
    ...
    @RequestMapping(
            path = [
                ChronicleApi.ORGANIZATION_ID_PATH + ChronicleApi.STUDY_ID_PATH +
                    ChronicleApi.PARTICIPANT_ID_PATH + ChronicleApi.DATASOURCE_ID_PATH + ChronicleApi.UPLOAD_PATH
            ],
            method = [RequestMethod.POST], consumes = [MediaType.APPLICATION_JSON_VALUE]
    )
    override fun upload(
    ...
    override fun getPropertyTypeIds(
            @Valid @RequestBody propertyTypeFqns: Set<FullQualifiedName>
