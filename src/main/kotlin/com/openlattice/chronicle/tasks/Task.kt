...
// reason: intentional package layout — this enum lives in the com.geekbeast.tasks namespace
// (shared framework package) while physically hosted under the chronicle tasks directory; moving
// the file would change the public package and break every import of com.geekbeast.tasks.Task
...
public enum class Task {
    ...
    CODEX_MESSAGE_SYNC_TASK,
    ENTITY_VIEWS_INITIALIZER,
    EDM_SYNC_INITIALIZER,
    ID_GEN_CATCH_UP,
    MOVE_TO_EVENT_STORAGE,
    MOVE_IOS_DATA_TO_EVENT_STORAGE,
    MOVE_ANDROID_SENSOR_DATA_TO_STORAGE,
    ...
    RECALCULATE_PARTICIPANT_STATS,
    STUDY_COMPLIANCE_TASK,
    MATERIALIZE_PERMISSION_SYNC_TASK,
    EXTERNAL_DATABASE_PERMISSIONS_SYNC_TASK,
    TRANSPORTER_MATERIALIZE_DATA_REFRESH_TASK,
    TRANSPORTER_SYNC_INITIALIZATION_TASK
}
