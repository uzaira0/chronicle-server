package com.openlattice.chronicle.authorization.aggregators
...
public open class PrincipalAggregator(private val principalsMap: MutableMap<AclKey, PrincipalSet>
    ...
    public fun getResult(): MutableMap<AclKey, PrincipalSet> {
