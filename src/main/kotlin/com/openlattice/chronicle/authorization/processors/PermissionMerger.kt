...
public data class PermissionMerger(
    private val objects: Iterable<Permission>,
    val securableObjectType: SecurableObjectType,
    val expirationDate: OffsetDateTime = OffsetDateTime.MAX
) : AbstractMerger<AceKey, AceValue, Permission>(objects), Offloadable {
