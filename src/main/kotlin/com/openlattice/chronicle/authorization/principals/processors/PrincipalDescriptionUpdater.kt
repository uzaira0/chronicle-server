...
public data class PrincipalDescriptionUpdater(
        val description: String
) : AbstractRhizomeEntryProcessor<AclKey, SecurablePrincipal, Any?>() {
    internal companion object {
        private const val serialVersionUID = -1888534083122168784L
    }
