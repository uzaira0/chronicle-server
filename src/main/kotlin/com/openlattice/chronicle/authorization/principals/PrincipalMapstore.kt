 ...
 */
@Component
public open class PrincipalMapstore(hds: HikariDataSource) : AbstractBasePostgresMapstore<AclKey, SecurablePrincipal>(
        HazelcastMap.PRINCIPALS,
        PRINCIPALS,
        hds
) {
    public companion object {
        public const val ACL_KEY_ROOT_INDEX: String = "aclKey[0]"
        public const val PRINCIPAL_ID_INDEX: String = "id"
        public const val PRINCIPAL_INDEX: String = "principal"
        public const val PRINCIPAL_TYPE_INDEX: String = "principalType"
