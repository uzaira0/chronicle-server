...
@Component
public open class SecurableObjectTypeMapstore(hds: HikariDataSource) : AbstractBasePostgresMapstore<AclKey, SecurableObjectType>(
    HazelcastMap.SECURABLE_OBJECT_TYPES,
    ChroniclePostgresTables.SECURABLE_OBJECTS,
    hds
) {
    public companion object {
        public const val ACL_KEY_INDEX: String = "__key.index"
        public const val SECURABLE_OBJECT_TYPE_INDEX: String = "this"
    }
