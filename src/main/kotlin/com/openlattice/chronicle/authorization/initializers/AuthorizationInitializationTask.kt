 ...
 */
public open class AuthorizationInitializationTask : HazelcastInitializationTask<AuthorizationInitializationDependencies> {
    override fun initialize(dependencies: AuthorizationInitializationDependencies) {
        ...
        spm.createSecurablePrincipalIfNotExists(SystemUser.CHRONICLE.principal, CHRONICLE_SERVICE_ROLE)
    ...
    internal companion object {
        ...
        @JvmField
        public val GLOBAL_USER_ROLE = Role(
                Optional.empty(),
        ...
        @JvmField
        public val GLOBAL_ADMIN_ROLE = Role(
            Optional.empty(),
            IdConstants.SYSTEM_ORGANIZATION.id,
        ...
        @JvmField
        public val CHRONICLE_SERVICE_ROLE = SecurablePrincipal(
            Optional.empty(),
            SystemUser.CHRONICLE.principal,
            "Chronicle Service Role",
            Optional.of("The system service role for operations that do not require authentication.")
        )

        @JvmField
        public val ANONYMOUS_USER_ROLE = Role(
            Optional.empty(),
            IdConstants.SYSTEM_ORGANIZATION.id,
