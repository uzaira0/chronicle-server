 ...
 */
@Component
public open class StudyMapstore(public val hds: HikariDataSource) : TestableSelfRegisteringMapStore<UUID, Study> {
    ...
    internal companion object {
        public const val NOTIFY_RESEARCHERS_INDEX = "notifyResearchers"
