...
public open class HazelcastQueue<T> internal constructor(public val name: String) : TypedQueueIdentifier<T> {
    ...
    public fun getQueue(hazelcast: HazelcastInstance): IQueue<T> {
        this.checker.check()
    ...
    internal companion object {
        ...
        // Future: re-enable formatter once https://jira.openlattice.com/browse/LATTICE-2394
        // is done, as we will lose all desired autoformatting until then.
