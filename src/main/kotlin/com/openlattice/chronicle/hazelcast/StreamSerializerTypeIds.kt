 ...
 * upgrade. **NOTE: Leave first entry in place**
 */
public enum class StreamSerializerTypeIds {
    /**
    ...
    SECURABLE_PRINCIPAL_ACCUMULATOR,
    SORTED_PRINCIPAL_SET,
    ...
    INTEGRATION_JOB,
    INTEGRATION_UPDATE,
    FLIGHT_PLAN_PARAMETERS_UPDATE,
    UPDATE_INTEGRATION_EP,
    UPDATE_INTEGRATION_STATUS_EP,
    ENVIRONMENT,
    INTEGRATION_STATUS,
    QUEUED_INTEGRATION_JOB,
    UPDATE_ORGANIZATION_SMS_ENTITY_SET_INFORMATION_ENTRY_PROCESSOR,
    UPDATE_EXTERNAL_TABLE_PROCESSOR,
    UPDATE_EXTERNAL_COLUMN_PROCESSOR,
    GET_NORMAL_ENTITY_SET_IDS_ENTRY_PROCESSOR,
    BASE_64_MEDIA,
    SCHEDULED_TASK_SERVICE,
    SCHEDULED_TASK,
    SEND_CODEX_MESSAGE_TASK,
    PERMISSION,
    AUTHORIZATION_ENTRY_PROCESSOR,
    PERMISSION_MAP_LISTENER,
    INT_SET,
    DELEGATED_UUID_LIST,
    UPDATE_SMS_INFORMATION_LAST_SYNC_ENTRY_PROCESSOR,
    PRINCIPAL_EXISTS_ENTRY_PROCESSOR,
    USERS_WITH_CONNECTIONS_AGGREGATOR,
    DISTRIBUTABLE_JOB,
    ...
    MATERIALIZED_VIEW_ACCOUNT,
    SUBSCRIPTION_NOTIFICATION,
    TRANSPORTER_PROPAGATE_DATA_ENTRY_PROCESSOR,
    TRANSPORTER_SYNCHRONIZE_TABLE_DEFINITION_ENTRY_PROCESSOR,
    TRANSPORTER_COLUMN_SET,
    TRANSPORTER_COLUMN,
    TRANSPORT_ENTITY_SET_EP,
    DESTROY_TRANSPORTED_ENTITY_SET_EP,
    GET_MEMBERS_FROM_ORG_EP,
    PRINCIPAL_TYPE,
    ORGANIZATION_DATABASE,
    GET_PRINCIPAL_FROM_SECURABLE_TYPE_EP,
    KOTLIN_DELEGATED_UUID_SET,
    TRANSPORTER_RUN_SYNC_TASK,
    ADD_PRINCIPAL_TO_PRINCIPAL_EP,
    POSTGRES_DATATYPE,
    GET_DB_USERNAME_FROM_DB_CREDS_EP,
    GET_PROPERTY_TYPES_TRANSPORTER_COL_SET_EP,
    GET_ORG_ID_FROM_ENTITY_SET_EP,
    ACCESS_TARGET,
    ADD_ENTITY_SET_FLAGS_EP,
    GET_SCHEMA_FROM_EXT_TABLE_EP,
    EXTERNAL_TABLE_EP,
    COLLABORATION,
    ALTER_ORGS_IN_COLLAB_EP,
    PROJECTED_TABLE_KEY,
    PROJECTED_TABLE_METADATA,
    JOB_STATUS,
    SECURABLE_OBJECT_METADATA,
    SECURABLE_OBJECT_METADATA_UPDATE,
    SECURABLE_OBJECT_METADATA_UPDATE_ENTRY_PROCESSOR,
