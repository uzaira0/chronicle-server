 ...
 */
@Component
public open class SecurablePrincipalStreamSerializer : SelfRegisteringStreamSerializer<SecurablePrincipal> {
    ...
    internal companion object {
        ...
        public fun serialize(out: ObjectDataOutput, securablePrincipal: SecurablePrincipal) {
            serialize(out, securablePrincipal.principal)
            serialize(out, securablePrincipal.aclKey)
            out.writeUTF(securablePrincipal.title)
            out.writeUTF(securablePrincipal.description)
        }

        @Throws(IOException::class)
        public fun deserialize(input: ObjectDataInput): SecurablePrincipal {
            val principal = PrincipalStreamSerializer.deserialize(input)
            val aclKey = AclKeyStreamSerializer.deserialize(input)
