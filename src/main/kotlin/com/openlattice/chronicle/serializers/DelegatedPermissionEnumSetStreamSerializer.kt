...
@Component
public open class DelegatedPermissionEnumSetStreamSerializer : SelfRegisteringStreamSerializer<DelegatedPermissionEnumSet?> {
    ...
    internal companion object {
        @JvmStatic
        @Throws(IOException::class)
        public fun serialize(out: ObjectDataOutput, permissions: EnumSet<Permission>?) {
            RhizomeUtils.Serializers.serializeEnumSet(out, Permission::class.java, permissions)
        }

        @JvmStatic
        @Throws(IOException::class)
        public fun deserialize(input: ObjectDataInput): EnumSet<Permission> {
            return RhizomeUtils.Serializers.deSerializeEnumSet(input, Permission::class.java)
        }
    }
}
