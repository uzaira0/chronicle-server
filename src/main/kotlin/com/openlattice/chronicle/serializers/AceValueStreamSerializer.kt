 ...
 */
@Component
public open class AceValueStreamSerializer : TestableSelfRegisteringStreamSerializer<AceValue> {
    ...
    internal companion object {
        ...
        @JvmStatic
        @Throws(IOException::class)
        public fun serialize(out: ObjectDataOutput, value: SecurableObjectType) {
            out.writeInt(value.ordinal)
        }

        @JvmStatic
        @Throws(IOException::class)
        public fun deserialize(input: ObjectDataInput): SecurableObjectType {
