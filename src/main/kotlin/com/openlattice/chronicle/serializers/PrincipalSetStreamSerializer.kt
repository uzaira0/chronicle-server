...
@Component
public open class PrincipalSetStreamSerializer : SetStreamSerializer<PrincipalSet, Principal>(PrincipalSet::class.java) {
    ...
    override fun readSingleElement(input: ObjectDataInput): Principal {
        return PrincipalStreamSerializer.deserialize(input)
    }

    @Throws(IOException::class)
    override fun writeSingleElement(output: ObjectDataOutput, element: Principal) {
        PrincipalStreamSerializer.serialize(output, element)
    }
