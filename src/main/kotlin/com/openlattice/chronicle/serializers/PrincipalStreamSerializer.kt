...
@Component
public open class PrincipalStreamSerializer : SelfRegisteringStreamSerializer<Principal> {
    ...
    // reason: `in`/`object` are escaped Kotlin keywords kept as the established stream-serializer
    // parameter convention, mirroring the SelfRegisteringStreamSerializer write/read overrides
    @Suppress("FunctionParameterNaming")
    internal companion object {
        @JvmStatic
        @Throws(IOException::class)
        @Suppress("DEPRECATION")
        public fun serialize(out: ObjectDataOutput, `object`: Principal) {
        ...
        @JvmStatic
        @Throws(IOException::class)
        public fun deserialize(`in`: ObjectDataInput): Principal {
