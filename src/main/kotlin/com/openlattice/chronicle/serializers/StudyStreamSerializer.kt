 ...
 */
@Component
public open class StudyStreamSerializer : TestableSelfRegisteringStreamSerializer<Study> {
    public companion object {
        ...
        public fun serialize(out: ObjectDataOutput, study: Study) {
        ...
        @JvmStatic
        @Throws(IOException::class)
        public fun deserialize(input: ObjectDataInput): Study {
            return Study(
