 ...
 */
public open class HazelcastLongIdService(hazelcastClientProvider: HazelcastClientProvider) {
     ...
     */
    public fun getId(scope: String): Long {
     ...
     * @return A unique long id (subject to hazelcast split brain mechanics).
     */
    public fun getIds(scope: String, count: Long): LongRange {
